...
public class DateUtils extends org.apache.commons.lang3.time.DateUtils {
    ...
    private static final String ALL_DAY_FLAG = "00:00:00";
    ...
    public static String formatDate(Date date) {
        ...
        if (formatDate.endsWith(ALL_DAY_FLAG)) {
            formatDate = DateFormatUtils.format(date, "yyyy-MM-dd");
        }
        return formatDate;
    }
    ...
    public static String getYearAndMonth(Date date) {
        ...
        int maxSingleNumber = 9;
        Calendar c = Calendar.getInstance();
        c.setTime(date);
        int year = c.get(Calendar.YEAR);
        int month = c.get(Calendar.MONTH);
        String time;
        if (month < maxSingleNumber) {
            time = String.valueOf(year) + "0" + Integer.toString(month + 1);
        } else {
            time = String.valueOf(year) + Integer.toString(month + 1);
        }
